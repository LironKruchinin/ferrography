...
#https://www.google.com/search?q=Use+trackbar+to+change+the+intensity+value+of+the+image+using+OpenCV+Python&sxsrf=ALiCzsYnADbMD96MxdsURoFAp02FfmmlHA%3A1659942240390&ei=YLXwYp-sF4CH9u8PwMCdoAE&ved=0ahUKEwif3Nfc1rb5AhWAg_0HHUBgBxQQ4dUDCA4&uact=5&oq=Use+trackbar+to+change+the+intensity+value+of+the+image+using+OpenCV+Python&gs_lcp=Cgdnd3Mtd2l6EAM6BwgAEEcQsANKBAhBGABKBAhGGABQhQJYhQJg3AloAXAAeACAAaMBiAGjAZIBAzAuMZgBAKABAqABAcgBCMABAQ&sclient=gws-wiz
...
if __name__ == '__main__':
    ...
    original = cv2.imread("photos/2008924x10.2.jpg")
