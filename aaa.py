...
originalImage = cv2.imread('photos/2008924x10.3.jpg', cv2.IMREAD_UNCHANGED)
...
for cnt in contours:
   ...
   if XYDistance > 11.5:
    ...
    cv2.putText(originalImage, str(XYDistance), (x, y-9), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (255, 0, 0), 1)
#    print(x, y)
#    print(w, h)
#    print(x+w, y+h)
#    print(XYDistance)
